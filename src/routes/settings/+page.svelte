...
<div class="py-10">
  <div class="animate-fade-up">
    <SectionHeader title="Settings" subtitle="Adjust projection assumptions and manage local finance data" />
    ...
    <Card class="mb-5">
      <CardHeader>
        ...
        <CardDescription
          >These values are stored locally and used across dashboard and projection charts.</CardDescription
        >
      </CardHeader>
      <CardContent>
